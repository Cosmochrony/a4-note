...
\begin{document}
  ...
  \begin{abstract}
    ...
    split
    opens spontaneously, leaving only the amplitude $|u|$ open.
  \end{abstract}
  ...
  \section{Determination of the genus: electric character of the chiral polarisation}
    ...
    which
    is not a genus question and is left open.
  ...
  \section{Status of results}
    ...
    \paragraph{Open.}
      The amplitude $|u|$, the A4 matching of the discrete chiral-frontier normalisation with $\muchi$.
      This is downstream of the genus and is not a genus question: the genus sign is determined in the Schur-transverse
      branch (Lemma~\ref{lem:index-assignment}), while the magnitude requires the explicit normalisation.
