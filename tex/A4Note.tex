...
\begin{document}
  ...
  = -2|\mathbf{E}_{\mathcal P}|^2$ on the electric branch, the radicand reduces to
    ...
    \begin{proposition}[Boundary-versus-interior selection]
      ...
      If $\Pchi \cdot \mathcal{R}_{\chi} > 0$ the radicand~\eqref{eq:Dchi-electric} has an interior turning point at
      $s_*^2 = |\mathbf{E}_{\mathcal P}|^2 / \big(2\, \Pchi \cdot \mathcal{R}_{\chi}\big)$, a candidate interior lock,
      admissible only if it lies before the first saturation contact, $\Dchi(s_*) > 0$.
    ...
    \begin{proof}
      ...
      exactly when $\Pchi \cdot \mathcal{R}_{\chi} > 0$; there the second derivative is
      $-4 |\mathbf{E}_{\mathcal P}|^2 \beta^{-2} \cdot (-1) = 4 |\mathbf{E}_{\mathcal P}|^2 \beta^{-2} > 0$, a minimum.
      For $\Pchi \cdot \mathcal{R}_{\chi} \leq 0$ both the quadratic and quartic coefficients are non-positive and
      $\Dchi(s)$ has no interior minimum at this order, so the admissible region terminates at the saturation locus
      $\Dchi(s) = 0$, where $\Bsat$ attains its floor $-\beta^2$ and A4 locks.
    \end{proof}
    ...
    \begin{remark}[Not a Landau closure]
      ...
      stabilisation is not a Landau mechanism: it is conditional on the interior turning point preceding the
