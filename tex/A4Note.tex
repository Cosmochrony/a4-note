...
\begin{document}
  ...
  \begin{abstract}
    ...
    amplitude $|u|$ reduces to the sign of a cubic backreaction together with a boundary-versus-interior selection
    of the saturation problem, leaving the magnitude as the sole open frontier.
  \end{abstract}
